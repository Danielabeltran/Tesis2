      ...
      public static void generarCodigo(Modelo m) throws IOException, SQLException 
      {
            for (Entidad e1: m.getEntidades())
            {
                    ...
                    for (int i=1; i<=2; i++)
                    {
                        ...
                        g.ldir ( f + "/src/conf");
                        g.ldir ( f + "/src/java");
                        g.ldir ( f + "/src/java/usbbogentities");
                        g.ldir ( f + "/src/java/usbbogdata");
                        g.ldir ( f + "/web");
                    ...
                    if (ConexionDB != null)
                    {
                            try 
                            {
                                BufferedWriter escritor = new BufferedWriter(new FileWriter(myfolder + NameDB + "/src/java/usbbogdata/"  +  "ConexionDB.java"));
