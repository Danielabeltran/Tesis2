...
//----------Lo que esta arriba no se modifica para la generacion de ninguna Capa-------------------------//
                    ...
                    try 
                    {
                         ModeloGeneratorData=Velocity.getTemplate("TemplatesMVC/TData.vsl");
                    ...
                    if(ModeloGeneratorData != null)
                    {
                        try 
                        {
                             BufferedWriter escritor = new BufferedWriter(new FileWriter(myfolder + nombreClase + "/src/java/usbbogdata/" + tablaClase +  "DAO.java"));
